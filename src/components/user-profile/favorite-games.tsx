...
const FavoriteGames = ({ data }: IProps) => {
    ...
    <>
      <div className="grid gap-y-8">
        <div className="flex justify-between items-center">
          <h2 className="text-start font-bold text-[24px]">Favourite Games</h2>
          <Link
        ...
        <div className="grid max-md:gap-y-[20px] max-md:gap-x-[20px] max-sm:grid-cols-2 grid-cols-7 max-[1200px]:gap-x-[10px] gap-x-[30px]">
          {userGames?.length !== 0 &&
            userGames?.slice(0, 4)?.map((game: any, index: number) => (
              <div
                key={index}
                className="relative w-full rounded-[13.3px] mb-4"
              >
                <div
                ...
                >
                  <Image
                    ...
                    width={17}
                    height={17}
                    className="w-[19.32px] h-[19.32px] min-h-[173px] hover:cursor-pointer"
                  />
                </div>
                <Link
                ...
                >
                  <Image
                    ...
                    width={128}
                    height={184}
                    className={`w-full h-full min-h-[184px] max-h-[184px] 2xl:min-h-[224px] 2xl:max-h-[224px] object-cover rounded-xl hover:cursor-pointer ${
                      index === 0
                ...
                <span
                  className={`absolute text-[80px] font-bold ${
                    index === 0
                      ...
                      ? "text-[#CD7F32]"
                      : "text-cPurple-light"
                  } leading-10 bottom-[10px] left-[-12px]`}
                  style={{
                    textShadow:
          ...
          <div
            ...
            className="relative bg-[#ffffff1a] rounded-[13.3px] grid items-end border-dashed border-[1px] border-cPurple-light hover:cursor-pointer h-[184px] min-h-[150px] 2xl:h-[224px] 2xl:min-h-[224px]"
          >
            <Image
              ...
              width={24}
              height={24}
              className="place-self-center absolute right-[auto] left-[auto] !top-[39%]"
            />

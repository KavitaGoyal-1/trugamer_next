...
const TrendingGameCard = ({
  ...
  return (
    <>
      <div
        className={`pt-3 md:pt-0 h-[205px] md:h-[340px] w-[142px] md:w-[236px] relative grid justify-items-center  m-auto sm:mr-auto z-[${index}]`}
      >
        ...
        >
          <Image
            ...
            width={236}
            height={340}
            className="z-0 h-[205px] md:h-[340px] md:min-w-[236px] md:max-w-[236px] w-full cursor-pointer rounded-2xl md:rounded-3xl object-cover"
          />
          <span
            className={`absolute leading-[60px] text-[80px] md:leading-[80px] md:text-[110px] font-bold text-cPurple-light bottom-[0px] md:bottom-[0px] left-[-10px] md:left-[-10px] text-transparent stroke-text `}
          >
            {index + 1}
          </span>
        </Link>
